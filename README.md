...
<h4>Project 1: Multimodal Applications in Ultrasound Imaging Diagnosis</h4>
  ...
  <p>
   Coursework of ZJU’s ECE445 (Senior Design). We designed a clothing folding machine, which is able to detect clothes, grab clothes and fold clothes. We use Mask-RCNN as our computer vision model to detect clothes and build our own training dataset. We also design an open-loop system with inverse kinematics method to drive the robot arm to grab clothes. Finally, clothes will be folded by an automatic folding machine. The link below shows how the robot works. 
  </p>
<!-- insert a video -->
https://www.youtube.com/watch?v=VXa4wbYny8w
